...
var socket = new _phoenix.Socket("/socket", { params: { token: window.userToken } }); // When you connect, you'll often need to authenticate the client.
...
var renderUsers = function renderUsers(presences) {
  onlineUsers.innerHTML = _phoenix.Presence.list(presences, listUsers).map(function (presence) {
    return "\n      <li>" + presence.user + "</li>";
  }).join("");
};
